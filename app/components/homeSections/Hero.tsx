...
export default function HeroSection({isActive}: {isActive: boolean}) {
  return (
    ...
    >
      ...
      >
        <h1 className="text-5xl font-bold mb-6 text-[#fab804]">Build Real Strength</h1>
        ...
        <button
          className="px-6 py-3 border border-[#fab804] text-[#fab804] rounded hover:bg-gray-300 hover:text-red-500 transition"
          onClick={() => {
